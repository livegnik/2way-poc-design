...
- `00-scope-overview.md` - Global invariants, trust boundaries, and invalid input handling.
- `01-scope-and-goals.md` - System scope, goals, allowed/forbidden behavior, and guarantees.
- `02-non-goals-and-out-of-scope.md` - Explicit exclusions and non-goals with rejection expectations.
- `03-definitions-and-terminology.md` - Canonical terms and object names used throughout the repo.
- `04-assumptions-and-constraints.md` - PoC assumptions, constraints, and hard exclusions.

Each document has a corresponding meta specification in `09-appendix/meta/00-scope/`.

## How to read

1. Start with `00-scope-overview.md` for the top-level invariants and trust boundaries.
2. Read `01-scope-and-goals.md` and `02-non-goals-and-out-of-scope.md` to understand the boundary.
3. Use `04-assumptions-and-constraints.md` to confirm what the PoC must and must not rely on.
4. Keep `03-definitions-and-terminology.md` open as a reference for canonical terms.
