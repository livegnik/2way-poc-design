...
Defines excluded behaviors, assumptions, and guarantees for the 2WAY PoC.
Specifies non-goals, forbidden interactions, and rejection expectations.
Constrains trust dependencies and enforcement boundaries for excluded features.
