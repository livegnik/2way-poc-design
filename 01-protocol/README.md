...
- `00-protocol-overview.md` - Protocol posture, lifecycle, guarantees, and forbidden paths.
- `01-identifiers-and-namespaces.md` - Identifier formats, namespaces, and scoping rules.
- `02-object-model.md` - Canonical graph object types and structural constraints.
- `03-serialization-and-envelopes.md` - Envelope format and structural validation rules.
- `04-cryptography.md` - Signature and encryption requirements.
- `05-keys-and-identity.md` - Key binding, identity rules, and revocation semantics.
- `06-access-control-model.md` - ACL semantics and authorization evaluation rules.
- `07-sync-and-consistency.md` - Sync ordering, domain scoping, and replay rules.
- `08-network-transport-requirements.md` - Transport constraints for sync traffic.
- `09-dos-guard-and-client-puzzles.md` - Admission control and client puzzle requirements.
- `10-errors-and-failure-modes.md` - Failure classification and rejection ordering.
- `11-versioning-and-compatibility.md` - Versioning and compatibility rules.

Each document has a corresponding meta specification in `09-appendix/meta/01-protocol/`.

## How to read

1. Start with `00-protocol-overview.md` for the end-to-end lifecycle and invariants.
2. Read `02-object-model.md`, then `03-serialization-and-envelopes.md` to learn structure and format.
3. Use `04-cryptography.md` and `05-keys-and-identity.md` for trust and key rules.
4. Read `06-access-control-model.md` for authorization semantics.
5. Use `07-sync-and-consistency.md` through `10-errors-and-failure-modes.md` for sync and failure rules.
6. Finish with `11-versioning-and-compatibility.md` for evolution constraints.
...
- All request-scoped work is bound to a complete `OperationContext`.
