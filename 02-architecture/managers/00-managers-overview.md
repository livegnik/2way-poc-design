...
For the meta specifications, see [00-managers-overview meta](../../10-appendix/meta/02-architecture/managers/00-managers-overview-meta.md).
...
## 2. Manager catalog and dependency graph
...
| --- | --- | --- | --- | --- |
| 01 | <span style="white-space:nowrap;">[Config](01-config-manager.md)</span> | Configuration ingestion, schema registry for settings, namespace snapshots, reloads. | [Storage Manager](02-storage-manager.md) (settings table), [ACL Manager](06-acl-manager.md) (export filtering). | All managers/services needing configuration. |
| 02 | <span style="white-space:nowrap;">[Storage](02-storage-manager.md)</span> | SQLite lifecycle, schema materialization, transactional persistence, sequence helpers. | [Config Manager](01-config-manager.md) (db path). | [Graph Manager](07-graph-manager.md), [State Manager](09-state-manager.md), [Config Manager](01-config-manager.md), [Schema Manager](05-schema-manager.md), [Log Manager](12-log-manager.md), [Event Manager](11-event-manager.md), [App Manager](08-app-manager.md). |
| 03 | <span style="white-space:nowrap;">[Key](03-key-manager.md)</span> | Key generation, storage, signing, ECIES crypto. | [Config Manager](01-config-manager.md) (key paths). | [Network Manager](10-network-manager.md), [State Manager](09-state-manager.md), [App Manager](08-app-manager.md), [DoS Guard Manager](14-dos-guard-manager.md). |
| 04 | <span style="white-space:nowrap;">[Auth](04-auth-manager.md)</span> | Local HTTP/WebSocket authentication -> [OperationContext](../services-and-apps/05-operation-context.md) inputs. | [Config Manager](01-config-manager.md) (routes), [App Manager](08-app-manager.md) (routing metadata), auth token store. | HTTP layer, all managers via [OperationContext](../services-and-apps/05-operation-context.md). |
| 05 | <span style="white-space:nowrap;">[Schema](05-schema-manager.md)</span> | Loads/validates graph schemas, resolves type ids, compiles sync domains. | [Graph Manager](07-graph-manager.md) (read access), [Storage Manager](02-storage-manager.md) (type tables), [Config Manager](01-config-manager.md) (limits). | [Graph Manager](07-graph-manager.md), [ACL Manager](06-acl-manager.md), [State Manager](09-state-manager.md), [App Manager](08-app-manager.md), services. |
| 06 | <span style="white-space:nowrap;">[ACL](06-acl-manager.md)</span> | Authorization for all graph reads/writes. | [Schema Manager](05-schema-manager.md) (defaults), [Graph Manager](07-graph-manager.md) (state), [Config Manager](01-config-manager.md) (policy). | [Graph Manager](07-graph-manager.md), [Event Manager](11-event-manager.md) (capsules), services. |
| 07 | <span style="white-space:nowrap;">[Graph](07-graph-manager.md)</span> | Single write path, canonical read surface, traversal helpers. | [Schema Manager](05-schema-manager.md), [ACL Manager](06-acl-manager.md), [Storage Manager](02-storage-manager.md), [Event Manager](11-event-manager.md), [Log Manager](12-log-manager.md), [State Manager](09-state-manager.md), [Config Manager](01-config-manager.md), [App Manager](08-app-manager.md). | [State Manager](09-state-manager.md), [Event Manager](11-event-manager.md) (post-commit), services. |
| 08 | <span style="white-space:nowrap;">[App](08-app-manager.md)</span> | Registers apps, app identities, app services. | [Storage Manager](02-storage-manager.md), [Key Manager](03-key-manager.md), [Config Manager](01-config-manager.md). | HTTP router, [Schema Manager](05-schema-manager.md) (per app), [Graph Manager](07-graph-manager.md), [ACL Manager](06-acl-manager.md). |
| 09 | <span style="white-space:nowrap;">[State](09-state-manager.md)</span> | Sync metadata, inbound envelope coordination, outbound package construction. | [Graph Manager](07-graph-manager.md), [Storage Manager](02-storage-manager.md), [Network Manager](10-network-manager.md), [Config Manager](01-config-manager.md), [Schema Manager](05-schema-manager.md). | [Network Manager](10-network-manager.md) (packages), [Health Manager](13-health-manager.md), services. |
| 10 | <span style="white-space:nowrap;">[Network](10-network-manager.md)</span> | Transport surfaces, bastion admission, crypto verification, peer discovery. | [DoS Guard Manager](14-dos-guard-manager.md), [Key Manager](03-key-manager.md), [State Manager](09-state-manager.md), [Config Manager](01-config-manager.md), [Health Manager](13-health-manager.md), [Event Manager](11-event-manager.md), [Log Manager](12-log-manager.md). | [State Manager](09-state-manager.md) (verified envelopes), [Health Manager](13-health-manager.md). |
| 11 | <span style="white-space:nowrap;">[Event](11-event-manager.md)</span> | Sole event publication surface (internal bus + WebSocket). | [ACL Manager](06-acl-manager.md) (audience capsules), [Graph Manager](07-graph-manager.md), [App Manager](08-app-manager.md), [Config Manager](01-config-manager.md), [Auth Manager](04-auth-manager.md), [DoS Guard Manager](14-dos-guard-manager.md). | Frontend clients, managers needing notifications. |
| 12 | <span style="white-space:nowrap;">[Log](12-log-manager.md)</span> | Structured logging, audit/security sinks, query APIs. | [Config Manager](01-config-manager.md) (log.*), filesystem. | [Event Manager](11-event-manager.md) (bridged alerts), [DoS Guard Manager](14-dos-guard-manager.md) (abuse signals), operators, [Health Manager](13-health-manager.md). |
| 13 | <span style="white-space:nowrap;">[Health](13-health-manager.md)</span> | Aggregates readiness/liveness across managers. | All managers (signals), [Config Manager](01-config-manager.md). | [DoS Guard Manager](14-dos-guard-manager.md) (admission multiplier), operators, [Event Manager](11-event-manager.md). |
| 14 | <span style="white-space:nowrap;">[DoS Guard](14-dos-guard-manager.md)</span> | Admission decisions, puzzles, telemetry to [Network Manager](10-network-manager.md). | [Network Manager](10-network-manager.md) (telemetry), [Config Manager](01-config-manager.md) (dos.*), [Key Manager](03-key-manager.md) (seeds), [Health Manager](13-health-manager.md). | [Network Manager](10-network-manager.md) (bastion), [Event Manager](11-event-manager.md), [Log Manager](12-log-manager.md). |
...
### 3.1 Local write pipeline (HTTP request -> graph commit)
...
### 3.4 Configuration reload pipeline
...
### 3.5 Observability and incident response
...
## 4. Manager-by-manager summary

### 4.1 [Config Manager](01-config-manager.md) (01)
...
* **Key services**:
  ...
  * Two-phase change propagation (prepare/commit) with per-manager veto.
* **Dependencies**: [Storage Manager](02-storage-manager.md) (settings table), [ACL Manager](06-acl-manager.md) (export filtering). Consumers: all managers/services.
* **Critical invariants**:
  * Only [Config Manager](01-config-manager.md) can update runtime configuration.
  * No manager reads raw `.env` or SQLite `settings` directly.
  * Configuration reloads are atomic and fail closed.

### 4.2 [Storage Manager](02-storage-manager.md) (02)

* **Scope**: Sole owner of SQLite connections, schema materialization, read/write transactions, and `global_seq` allocation.
* **Key services**:
  * Transaction Manager (serializable writes, retries inside a transaction only).
  * Schema Materialization (DDL, migrations, indices).
  * Sequence Engine (monotonic `global_seq`, per-domain snapshots).
* **Dependencies**: [Config Manager](01-config-manager.md) (paths, limits). Consumers: [Graph Manager](07-graph-manager.md), [Schema Manager](05-schema-manager.md), [State Manager](09-state-manager.md), [Log Manager](12-log-manager.md), [Event Manager](11-event-manager.md).
* **Critical invariants**:
  * No component bypasses [Storage Manager](02-storage-manager.md) for SQLite access.
  * Transactions either commit fully or roll back.
  * Sequence allocation is monotonically increasing and never reused.

### 4.3 [Key Manager](03-key-manager.md) (03)

* **Scope**: Exclusive custody of private keys, key generation, signing, decryption, and revocation checks.
* **Key services**:
  * Key Vault (load/store, rotation, revocation lookup).
  * Crypto Engine (secp256k1 signing, ECIES decryption, deterministic signing).
  * Identity Binding (key -> identity resolution integration with [Graph Manager](07-graph-manager.md)).
* **Dependencies**: [Config Manager](01-config-manager.md) (key paths), [Storage Manager](02-storage-manager.md) (revocation data), [Graph Manager](07-graph-manager.md) (identity bindings). Consumers: [Network Manager](10-network-manager.md), [State Manager](09-state-manager.md), [App Manager](08-app-manager.md).
* **Critical invariants**:
  * Private keys never leave [Key Manager](03-key-manager.md).
  * All private-key crypto operations run inside [Key Manager](03-key-manager.md).
  * Revoked keys cannot be used to sign or decrypt.

### 4.4 [Auth Manager](04-auth-manager.md) (04)

* **Scope**: Validates local sessions, resolves identities, and binds [OperationContext](../services-and-apps/05-operation-context.md) for local calls.
* **Key services**:
  * Session validation and token issuance.
  * Identity + app context binding.
  * Request metadata normalization for [OperationContext](../services-and-apps/05-operation-context.md).
* **Dependencies**: [Config Manager](01-config-manager.md) (auth policies), [App Manager](08-app-manager.md) (routing metadata), [Graph Manager](07-graph-manager.md) (identity references). Consumers: HTTP/WebSocket layers, services.
* **Critical invariants**:
  * No local request reaches [Graph Manager](07-graph-manager.md) without a valid [OperationContext](../services-and-apps/05-operation-context.md).
  * Transport metadata is never treated as authenticated identity.

### 4.5 [Schema Manager](05-schema-manager.md) (05)

* **Scope**: Canonical schema authority; compiles app schemas, resolves type IDs, and enforces schema constraints for all writes/reads.
* **Key services**:
  * Schema compilation and caching.
  * Type resolution (`type_key` <-> `type_id`).
  * Domain binding and schema validation rules.
* **Dependencies**: [Graph Manager](07-graph-manager.md) (schema data), [Storage Manager](02-storage-manager.md), [Config Manager](01-config-manager.md). Consumers: [Graph Manager](07-graph-manager.md), [ACL Manager](06-acl-manager.md), [State Manager](09-state-manager.md).
* **Critical invariants**:
  * Schema validation always runs before [ACL Manager](06-acl-manager.md).
  * Unknown types or domains are rejected.

### 4.6 [ACL Manager](06-acl-manager.md) (06)
...
### 4.7 [Graph Manager](07-graph-manager.md) (07)
...
### 4.8 [App Manager](08-app-manager.md) (08)

* **Scope**: Declares and registers applications, assigns `app_id` values, binds app identities to keys, initializes per-app storage, and wires optional app services.
* **Key services**:
  * Persistent registry (slug <-> `app_id`).
  * Application identity Parents in app_0, generated via [Key Manager](03-key-manager.md).
  * App service wiring with enforced manager boundaries.
...
* **Critical invariants**:
  ...
  * App services cannot bypass managers or access raw storage/key/network.

### 4.9 [State Manager](09-state-manager.md) (09)
...
### 4.10 [Network Manager](10-network-manager.md) (10)
...
### 4.11 [Event Manager](11-event-manager.md) (11)
...
### 4.12 [Log Manager](12-log-manager.md) (12)
...
### 4.13 [Health Manager](13-health-manager.md) (13)
...
### 4.14 [DoS Guard Manager](14-dos-guard-manager.md) (14)
...
## 5. Startup and shutdown choreography

### 5.1 Startup order (high-level)
...
## 6. [OperationContext](../services-and-apps/05-operation-context.md) and trust boundaries
...
* **Trusted vs. untrusted inputs**:
  * Transport data remains untrusted until [Network Manager](10-network-manager.md) + [DoS Guard Manager](14-dos-guard-manager.md) complete signature checks and any required decryption via [Key Manager](03-key-manager.md).
...
## 7. Observability, readiness, and failure posture
