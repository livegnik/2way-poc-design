...
- `00-managers-overview.md` - System-wide manager invariants, dependencies, and execution flows.
- `01-config-manager.md` - Configuration ingestion and reload sequencing.
- `02-storage-manager.md` - SQLite lifecycle, transactions, and sequence allocation.
- `03-key-manager.md` - Private key custody and cryptographic operations.
- `04-auth-manager.md` - Session validation and `OperationContext` binding for local calls.
- `05-schema-manager.md` - Schema compilation, type resolution, and validation.
- `06-acl-manager.md` - Authorization for all reads and writes.
- `07-graph-manager.md` - Single write path and authoritative read surface.
- `08-app-manager.md` - App registration, app identities, and extension wiring.
- `09-state-manager.md` - Sync metadata and package coordination.
- `10-network-manager.md` - Transport surfaces and edge cryptography.
- `11-event-manager.md` - Event publication and subscriber enforcement.
- `12-log-manager.md` - Structured logging and audit sinks.
- `13-health-manager.md` - Readiness/liveness aggregation.
- `14-dos-guard-manager.md` - Admission control and client puzzles.

Each document has a corresponding meta specification in `09-appendix/meta/02-architecture/managers/`.

## How to read

1. Start with `00-managers-overview.md` for the shared invariants and dependencies.
2. Read the core enforcement managers (`02-storage-manager.md`, `05-schema-manager.md`,
   `06-acl-manager.md`, `07-graph-manager.md`) in order.
3. Review edge managers (`03-key-manager.md`, `10-network-manager.md`, `14-dos-guard-manager.md`)
   for ingress/egress guarantees.
4. Finish with observability and control (`11-event-manager.md`, `12-log-manager.md`,
   `13-health-manager.md`, `01-config-manager.md`).
...
- Auth Manager binds local requests to a complete `OperationContext`.
...
- Verify that manager dependencies and ordering follow `00-managers-overview.md`.
