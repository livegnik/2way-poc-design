...
### 1.1 Canonical graph state relationship
...
### 1.2 State metadata owned by State Manager
...
### 1.3 Derived and transient structures
...
## 2. Internal engines and execution phases
...
### 3.1 Global ordering guarantees
...
### 3.2 Inbound ordering enforcement
...
## 4. Inbound remote envelope handling

### 4.1 Inbound processing stages
...
### 4.2 Operation context construction
