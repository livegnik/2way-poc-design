...
This overview is responsible for:
...
* Highlighting shared invariants: OperationContext discipline, manager-only state access, and fail-closed behavior.
...
| Application (app) | Registered identity with schemas, ACL policy, and UX semantics. | Single app | App Manager registry |
...
2. **OperationContext discipline**: Every request and job supplies a complete, immutable OperationContext as defined in [02-architecture/services-and-apps/05-operation-context.md](05-operation-context.md).
...
* App Manager loads application identities and extension metadata.
...
* [02-architecture/services-and-apps/05-operation-context.md](05-operation-context.md) for OperationContext structure and lifecycle rules.
