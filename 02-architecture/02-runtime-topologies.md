...
Defines permitted runtime arrangements for 2WAY nodes and their trust boundaries.
Specifies component placement, allowed interactions, and failure behavior per topology.
Defines invariants that must hold across all runtime configurations.
