...
* Protocol rules have traceability entries in [TRACEABILITY.md](../../docs-build/TRACEABILITY.md).
* Phase exit criteria are backed by runnable tests in the build plan.
* System-level black-box tests map to [POC-ACCEPTANCE.md](../../docs-build/POC-ACCEPTANCE.md) criteria.

## 3. System-level black-box alignment

The acceptance criteria are defined in [POC-ACCEPTANCE.md](../../docs-build/POC-ACCEPTANCE.md). System-level black-box tests that verify each criterion exist and are runnable.

## 4. Execution rules

All tests run under pytest. See [TEST-CONVENTIONS.md](../../docs-build/TEST-CONVENTIONS.md) for markers and layout.
