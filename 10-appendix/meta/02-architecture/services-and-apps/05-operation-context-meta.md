...
* [02-architecture/managers/06-acl-manager.md](../../../../02-architecture/managers/06-acl-manager.md)
...
* Defining how OperationContext is consumed by [Graph Manager](../../../../02-architecture/managers/07-graph-manager.md), [ACL Manager](../../../../02-architecture/managers/06-acl-manager.md), [State Manager](../../../../02-architecture/managers/09-state-manager.md), [Event Manager](../../../../02-architecture/managers/11-event-manager.md), and [Log Manager](../../../../02-architecture/managers/12-log-manager.md).
