...
* Coordinating inbound remote envelopes after [Network Manager](../../../../02-architecture/managers/10-network-manager.md) verification and before [Graph Manager](../../../../02-architecture/managers/07-graph-manager.md) application, preserving the envelope guarantees in [01-protocol/03-serialization-and-envelopes.md](../../../../01-protocol/03-serialization-and-envelopes.md).
...
* Persisting and recovering state metadata and sync checkpoints via [Storage Manager](../../../../02-architecture/managers/02-storage-manager.md) so durability guarantees expected by [01-protocol/07-sync-and-consistency.md](../../../../01-protocol/07-sync-and-consistency.md) are upheld.
...
* Declaring the `state.*` configuration surface and its sync limit keys.
* Declaring error mapping for sync rejections and outbound sync failures surfaced via transport.
...
* DoS mitigation, client puzzles, or connection throttling, which are defined for [Network Manager](../../../../02-architecture/managers/10-network-manager.md) and [DoS Guard Manager](../../../../02-architecture/managers/14-dos-guard-manager.md) in [01-protocol/09-dos-guard-and-client-puzzles.md](../../../../01-protocol/09-dos-guard-and-client-puzzles.md).
