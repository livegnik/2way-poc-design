...
* Collecting periodic health samples and event-driven signals from every manager ([Config Manager](../../../../02-architecture/managers/01-config-manager.md), [Storage Manager](../../../../02-architecture/managers/02-storage-manager.md), [Graph Manager](../../../../02-architecture/managers/07-graph-manager.md), [Schema Manager](../../../../02-architecture/managers/05-schema-manager.md), [ACL Manager](../../../../02-architecture/managers/06-acl-manager.md), [Key Manager](../../../../02-architecture/managers/03-key-manager.md), [Auth Manager](../../../../02-architecture/managers/04-auth-manager.md), [App Manager](../../../../02-architecture/managers/08-app-manager.md), [State Manager](../../../../02-architecture/managers/09-state-manager.md), [Network Manager](../../../../02-architecture/managers/10-network-manager.md), [Event Manager](../../../../02-architecture/managers/11-event-manager.md), [Log Manager](../../../../02-architecture/managers/12-log-manager.md), [DoS Guard Manager](../../../../02-architecture/managers/14-dos-guard-manager.md)) plus critical services (HTTP/WebSocket loop, scheduler, transport adapters).
...
* Defining intake and publication safeguards (`health.ingest.max_signals`, `health.publication.max_retries`) for fail-closed health processing.
* Publishing health state via in-process subscription APIs, the admin HTTP surface described in [01-protocol/00-protocol-overview.md](../../../../01-protocol/00-protocol-overview.md) ([OperationContext](../../../../02-architecture/services-and-apps/05-operation-context.md) driven), and optional [Event Manager](../../../../02-architecture/managers/11-event-manager.md) notifications (`system.health_state_changed`, `security.health_degraded`) without leaking sensitive metadata.
* Recording health transitions as structured logs routed through [Log Manager](../../../../02-architecture/managers/12-log-manager.md).
...
* Providing a single place where [DoS Guard Manager](../../../../02-architecture/managers/14-dos-guard-manager.md), [Log Manager](../../../../02-architecture/managers/12-log-manager.md), and operators can learn when the node runtime intentionally stops accepting traffic due to local degradation, aligning with DoS Guard escalation rules in [01-protocol/09-dos-guard-and-client-puzzles.md](../../../../01-protocol/09-dos-guard-and-client-puzzles.md).

This specification does not cover the following:

* Automatic remediation, restart logic, or hardware-level monitoring.
* Service-specific diagnostics or deep metrics (e.g., [Graph Manager](../../../../02-architecture/managers/07-graph-manager.md) internal counters). [Health Manager](../../../../02-architecture/managers/13-health-manager.md) references only the signals that other managers emit.
* UI dashboards, notification routing outside [Event Manager](../../../../02-architecture/managers/11-event-manager.md), or long-term metrics retention.
