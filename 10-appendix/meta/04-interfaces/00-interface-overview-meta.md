...
* [04-interfaces/**](./)
* [01-local-http-api.md](../../../04-interfaces/01-local-http-api.md)
* [02-websocket-events.md](../../../04-interfaces/02-websocket-events.md)
* [03-internal-apis-between-components.md](../../../04-interfaces/03-internal-apis-between-components.md)
...
* Noting that internal manager APIs define canonical read request/response schemas for complex queries.
