...
* Per-app data modeling, which is defined in [03-data/03-per-app-tables.md](../../../03-data/03-per-app-tables.md)
* Index requirements, which are defined in [03-data/04-indexing-strategy.md](../../../03-data/04-indexing-strategy.md)
