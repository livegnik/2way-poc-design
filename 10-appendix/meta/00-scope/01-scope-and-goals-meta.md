...
This document is normative. All other design documents in this repository must conform to the constraints, invariants, and boundaries defined here. Terminology is defined in [03-definitions-and-terminology.md](../../../00-scope/03-definitions-and-terminology.md).
